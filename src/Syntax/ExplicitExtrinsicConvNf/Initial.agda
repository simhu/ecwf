...
--    {-
    ...
    m-resp = BLOCK
    -- m-resp pΔ (ctx-cons pΓ pA) pτ (subst-<> (subst-comp (ctx-cons pΓ' pA') (subst-pp pA'') pτ') pA''' (ter-subst-conv x (ter-qq-conv x₄ x₅) x₁ x₂ x₃)) (subst-eq-<>-η pτ'') = {!!}
      -- let open EqRelReason ~seq in
      -- begin
    ...
    -- TODO: Needed in definition of m??????
