{-# OPTIONS --with-K --allow-unsolved-metas #-}
-- TODO: can we typecheck this w/o K?
-- {-# OPTIONS --without-K #-}
module Syntax.ExplicitExtrinsicCoe.Initial where
...
module Elim {ks kr lo lh lr : Level}
  ...
  open import Syntax.ExplicitExtrinsicCoe
  ...
  mutual -- the interpretation
    ...
    m pΔ (ctx-cons pΓ pA') (subst-<> pσ pA pt) =
      ...
      -- probably..)
       < m pΔ pΓ pσ , BLOCK >E --  ter pΔ (ty-subst pΓ pA' pσ) pt >E -- ι {!!} (ter pΔ (ty-subst pΓ pA' pσ) pt) >E
    ...
    --   --   m pΞ' pΓ pσ' ∘E m pΔ pΞ' pτ'
    --   -- ∎
    -- m-resp pΔ (ctx-cons pΓ pA) (subst-<> pσ pA' pt) (subst-<> pτ pA'' ps) (subst-eq-<> pA''' pστ pst) = BLOCK
    ...
    -- Ind(pt : Γ ⊢ t ∈ A).
    -- ter = BLOCK
    ter pΓ pA (ter-coe pB pt pBA) = ι' (ty-cong pΓ pB pA pBA) (ter pΓ pB pt)
    ...
    --   ≈⟨ []t-resp-r (m# pΓ pΔ pσ pσ') ⟩
    --     ι _ (ter pΔ pA pt [ m pΓ pΔ pσ' ]tE)
    --   ≈⟨ ιresp ([]t-resp-l (ter# pΔ pΔ' pA pA' pt pt')) ⟩
    --     ι _ ((ι _ (ter pΔ' pA' pt' [ o# pΔ pΔ' ]tE)) [ m pΓ pΔ pσ' ]tE)
    --   ≈⟨ ιresp ιsubst ⟩
    --     ι _ (ι _ (ter pΔ' pA' pt' [ o# pΔ pΔ' ]tE  [ m pΓ pΔ pσ' ]tE))
    --   ≈⟨ ιtrans ⟩
    --     ι _ ((ter pΔ' pA' pt' [ o# pΔ pΔ' ]tE) [ m pΓ pΔ pσ' ]tE)
    --   ≈⟨ ιresp []t-assoc ⟩
    --     ι _ (ι _ (ter pΔ' pA' pt' [ o# pΔ pΔ' ∘E m pΓ pΔ pσ' ]tE))
    --   ≈⟨ ιresp (ιresp ([]t-resp-r (~seq .sym (m-o# pΓ' pΓ pΔ' pΔ pσ')))) ⟩
    --     ι _ (ι _ (ι _ (ter pΔ' pA' pt' [ m pΓ' pΔ' pσ' ∘E o# pΓ pΓ' ]tE)))
    --   ≈⟨ ~teq .trans ιtrans ιtrans ⟩
    --     ι _ (ter pΔ' pA' pt' [ m pΓ' pΔ' pσ' ∘E o# pΓ pΓ' ]tE)
    --   ≈⟨ ιirr ⟩
    --     ι _ (ter pΔ' pA' pt' [ m pΓ' pΔ' pσ' ∘E o# pΓ pΓ' ]tE)
    --   ≈⟨ ιtrans-inv ⟩
    --     ι _ (ι _ (ter pΔ' pA' pt' [ m pΓ' pΔ' pσ' ∘E o# pΓ pΓ' ]tE))
    --   ≈⟨ ιresp (~teq .sym []t-assoc) ⟩
    --      ι _ ((ter pΔ' pA' pt' [ m pΓ' pΔ' pσ' ]tE) [ o# pΓ pΓ' ]tE)
    --   ∎
    -- ter# pΓ pΓ' pA pA' (ter-coe {A = B} pB pt pBA) (ter-coe pB' pt' pBA') =
    --   let open EqRelReason ~teq in
    --   begin
    --     ι' (ty-cong pΓ pB pA pBA) (ter pΓ pB pt)
    --   ≈⟨ ιresp (ter# pΓ pΓ' pB pB' pt pt') ⟩
    --     ι' (ty-cong pΓ pB pA pBA) (ι (ty# pΓ pΓ' pB pB') (ter pΓ' pB' pt' [ o# pΓ pΓ' ]tE))
    --   ≈⟨ ιtrans ⟩
    --     ι _ (ter pΓ' pB' pt' [ o# pΓ pΓ' ]tE)
    --   ≈⟨ ιirr ⟩
    --     ι _ (ter pΓ' pB' pt' [ o# pΓ pΓ' ]tE)
    --   ≈⟨ ιtrans-inv ⟩
    --     ι _ (ι _ ((ter pΓ' pB' pt') [ o# pΓ pΓ' ]tE))
    --   ≈⟨ ιresp ιsubst-inv ⟩
    --     ι (ty# pΓ pΓ' pA pA')
    --       ((ι' (ty-cong pΓ' pB' pA' pBA') (ter pΓ' pB' pt')) [ o# pΓ pΓ' ]tE)
    --   ∎
    -- ter# (ctx-cons pΓ1 pA1) (ctx-cons pΓ2 pA2) (ty-subst pΓ3 pA3 (subst-pp pA5)) (ty-subst pΓ4 pA4 (subst-pp pA6)) (ter-qq pA7) (ter-qq pA8) = {!!}
